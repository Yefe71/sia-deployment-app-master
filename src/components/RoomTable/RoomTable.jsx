        ...
        <Box onClick = {() => {
          ...
          <div className={RoomTableCSS.topItems}>
            ...
            <div className={RoomTableCSS.fieldLabels}>
              ...
              <h3 className={RoomTableCSS.label2}>First Name</h3>
              <h3 className={RoomTableCSS.label3}>Middle Name</h3>
              <h3 className={RoomTableCSS.label4}>Employment</h3>
              <h3 className={RoomTableCSS.label5}>Max Units</h3>
            </div>
          </div>
